...
function Sect(props) {
  return /*#__PURE__*/_react["default"].createElement("output", null, props.chunk);
}
...
function TextBox() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      _final.push( /*#__PURE__*/_react["default"].createElement(Sect, {
...
ReactDOM.render( /*#__PURE__*/_react["default"].createElement(TextBox, null), document.getElementById('main'));